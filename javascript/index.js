...
let mhiya = new Queen("Mhi'ya Iman Le'Paige", 6, 6, 11, 6, 7, 8, 15, "Mhiya");
let mirage = new Queen("Mirage", 5, 6, 12, 7, 6, 6, 10, "Mirage");
let morphine = new Queen("Morphine Love Dion", 7, 7, 9, 7, 7, 10, 7, "Morphine");
let nymphia = new Queen("Nymphia Wind", 7, 10, 9, 15, 5, 12, 7, "Nymphia");
let plane = new Queen("Plane Jane", 8, 10, 9, 9, 10, 9, 9, "Plane");
let plasma = new Queen("Plasma", 11, 9, 8, 6, 9, 9, 8, "Plasma");
let q = new Queen("Q", 9, 8, 4, 15, 8, 10, 5, "Q");
let sapphira = new Queen("Sapphira Cristál", 7, 8, 9, 8, 7, 12, 9, "Sapphira");
