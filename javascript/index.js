...
let mhiya = new Queen("Mhi'ya Iman Le'Paige", 6, 6, 11, 6, 7, 8, 13, "Mhiya");
let mirage = new Queen("Mirage", 5, 6, 12, 7, 6, 6, 10, "Mirage");
let morphine = new Queen("Morphine Love Dion", 7, 7, 9, 7, 7, 10, 10, "Morphine");
...
let q = new Queen("Q", 9, 8, 4, 15, 8, 8, 5, "Q");
let sapphira = new Queen("Sapphira Cristál", 7, 8, 9, 8, 10, 12, 9, "Sapphira");
let xunami = new Queen("Xunami Muse", 7, 5, 8, 7, 5, 10, 7, "Xunami");
...
//DRUK SEASON 5  acting, comedy, dance, design, improv, runway, lipsync
...
let giametric = new Queen("Gia Metric", 11, 10, 10, 6, 9, 9, 8, "Giametric");
