...
let jessica = new Queen("Jessica Wild", 8, 9, 11, 9, 8, 8, 12, "Jessica");
...
let alexism = new Queen("Alexis Michelle", 13, 8, 7, 7, 13, 7, 10, "AlexisM");
let eureka = new Queen("Eureka!", 9, 11, 8, 10, 13, 10, 12, "Eureka");
let farrah = new Queen("Farrah Moan", 9, 4, 7, 3, 6, 8, 7, "Farrah");
let jaymes = new Queen("Jaymes Mansfield", 10, 9, 3, 8, 8, 10, 7, "Jaymes");
...
let kandym = new Queen("Kandy Muse", 7, 8, 7, 8, 8, 8, 13, "KandyM");
let lala = new Queen("LaLa Ri", 7, 8, 13, 5, 6, 8, 15, "Lala");
...
//SEASON 15
let amethyst = new Queen("Amethyst", 4, 10, 8, 5, 10, 8, 12, "Amethyst");
...
// ALL STARS 8
let allstars_8 = [alexism, darienne, heidi, jimbo, jaymes, jessica, kahanna, kandym, kasha, lala, monica, naysha];
...
//DRAG RACE ESPAÑA S3
let bestiah = new Queen("Bestiah", 7, 7, 9, 7, 7, 10, 9, "Bestiah");
let chanel = new Queen("Chanel Anorex", 7, 7, 8, 7, 7, 7, 8, "ChanelAnorex");
let clover = new Queen("Clover Bish", 7, 7, 9, 7, 7, 7, 9, "CloverBish");
let chuchi = new Queen("Drag Chuchi", 7, 6, 9, 7, 7, 7, 10, "DragChuchi");
let hornella = new Queen("Hornella Góngora", 7, 7, 9, 7, 7, 7, 7, "HornellaGongora");
let maria = new Queen("María Edília", 7, 7, 7, 7, 7, 7, 5, "MariaEdilia");
let kellyRoller = new Queen("Kelly Roller", 7, 7, 7, 7, 7, 6, 7, "KellyRoller");
let pakita = new Queen("Pakita", 9, 7, 13, 7, 7, 9, 9, "Pakita");
let pink = new Queen("Pink Chadora", 7, 8, 8, 7, 7, 8, 9, "PinkChadora");
let pitita = new Queen("Pitita", 7, 7, 7, 7, 7, 6, 7, "Pitita");
let vania = new Queen("Vania Vainilla", 7, 7, 7, 7, 7, 9, 7, "VaniaVainilla");
let visa = new Queen("Visa", 7, 7, 9, 7, 7, 9, 7, "Visa");
