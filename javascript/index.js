...
// GLOBAL ALL STARS
let allstars_global = [alyssa, vanessa, peppermint, naomi, tayce, kitty, bobo, jada, elektra, kween, kana, turing, farida];
...
let chanel = new Queen("Chanel Anorex", 7, 7, 7, 7, 7, 7, 8, "ChanelAnorex");
let clover = new Queen("Clover Bish", 7, 7, 7, 7, 7, 7, 7, "CloverBish");
let chuchi = new Queen("Drag Chuchi", 7, 9, 7, 7, 7, 7, 10, "DragChuchi");
...
let pakita = new Queen("Pakita", 7, 7, 13, 7, 7, 7, 7, "Pakita");
