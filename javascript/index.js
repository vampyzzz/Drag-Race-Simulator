...
let plasma = new Queen("Plasma", 8, 10, 7, 6, 10, 7, 7, "Plasma");
let q = new Queen("Q", 9, 8, 4, 15, 8, 10, 5, "Q");
let sapphira = new Queen("Sapphira Cristál", 7, 8, 8, 8, 7, 12, 9, "Sapphira");
let xunami = new Queen("Xunami Muse", 7, 7, 8, 7, 7, 10, 7, "Xunami");
...
let kellyH = new Queen("Kelly Heelton", 10, 11, 7, 8, 10, 8, 7, "KellyHeelton");
...
let yvonne = new Queen("Yvonne Nightstand", 10, 11, 7, 6, 8, 9, 7, "YvonneNightstand");
