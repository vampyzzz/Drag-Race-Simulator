...
let kendall = new Queen("Kendall Gender", 6, 7, 10, 6, 7, 6, 10, "Kendall");
let kimoraA = new Queen("Kimora Amour", 6, 5, 5, 6, 7, 7, 5, "KimoraA");
let oceane = new Queen("Océane Aqua-Black", 6, 9, 9, 7, 7, 7, 10, "Oceane");
let pythia = new Queen("Pythia", 8, 9, 6, 14, 9, 13, 6, "Pythia");
let stephanie = new Queen("Stephanie Prince", 9, 9, 11, 12, 5, 11, 10, "Stephanie");
