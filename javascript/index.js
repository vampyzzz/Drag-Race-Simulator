...
let willow = new Queen("Willow Pill", 11, 9, 7, 12, 8, 12, 8, "Willow");
...
let malaysia = new Queen("Malaysia Babydoll Foxx", 9, 7, 7, 8, 7, 9, 8, "MalaysiaBabydollFoxx");
...
let nymphia = new Queen("Nymphia Wind", 7, 10, 9, 15, 7, 12, 7, "Nymphia");
let plane = new Queen("Plane Jane", 8, 9, 9, 9, 9, 9, 9, "Plane");
let plasma = new Queen("Plasma", 11, 10, 8, 6, 10, 9, 8, "Plasma");
