...
let luxx = new Queen("Luxx Noir London", 10, 11, 8, 13, 8, 13, 9, "LuxxNoirLondon");
...
let admira = new Queen("Admira Thunderpussy", 7, 7, 7, 6, 7, 11, 7, "AdmiraThunderpussy");
let almighty = new Queen("Almighty Aphroditey", 5, 4, 4, 5, 5, 4, 5, "AlmightyAphroditey");
let antonina = new Queen("Antonina Nutshell", 4, 4, 3, 4, 3, 2, 5, "AntoninaNutshell");
...
let santana = new Queen("Santana Sexmachine", 7, 7, 9, 9, 7, 9, 7, "SantanaSexmachine");
let vanityVain = new Queen("Vanity Vain", 6, 5, 7, 11, 6, 9, 8, "VanityVain");
