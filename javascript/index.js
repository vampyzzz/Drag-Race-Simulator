...
let ninaf = new Queen("Nina Flowers", 7, 5, 8, 11, 6, 12, 8, "NinaFlowers");
let ongina = new Queen("Ongina", 9, 8, 7, 9, 10, 9, 8, "Ongina");
let rebecca = new Queen("Rebecca Glasscock", 3, 3, 6, 4, 2, 6, 5, "Rebecca");
let shannel = new Queen("Shannel", 7, 7, 8, 9, 6, 11, 10, "Shannel");
...
let sonique = new Queen("Kylie Sonique Love", 11, 10, 10, 10, 10, 11, 11, "Kylie");
...
let delta = new Queen("Delta Work", 8, 9, 5, 5, 5, 7, 7, "Delta");
...
let willam = new Queen("Willam", 15, 12, 9, 10, 12, 9, 8, "Willam");
...
let detox = new Queen("Detox", 10, 12, 9, 9, 8, 12, 11, "Detox");
...
let roxxxy = new Queen("Roxxxy Andrews", 8, 8, 10, 13, 8, 12, 15, "Roxxxy");
...
let fame = new Queen("Miss Fame", 8, 4, 5, 11, 3, 13, 5, "MissFame");
let kasha = new Queen("Mrs. Kasha Davis", 11, 10, 7, 4, 6, 8, 8, "Kasha");
...
let naysha = new Queen("Naysha Lopez", 6, 4, 8, 4, 5, 9, 8, "Naysga");
let robbie = new Queen("Robbie Turner", 4, 5, 6, 4, 3, 6, 6, "Robbie");
let thorgy = new Queen("Thorgy Thor", 14, 12, 6, 9, 14, 9, 8, "Thorgy");
...
let alexism = new Queen("Alexis Michelle", 13, 8, 8, 8, 13, 7, 10, "AlexisM");
let eureka = new Queen("Eureka!", 9, 11, 8, 10, 13, 10, 12, "Eureka");
let farrah = new Queen("Farrah Moan", 9, 4, 7, 3, 6, 8, 7, "Farrah");
let jaymes = new Queen("Jaymes Mansfield", 10, 9, 3, 8, 9, 10, 5, "Jaymes");
...
//SEASON 10: 
let aquaria = new Queen("Aquaria", 6, 11, 8, 15, 12, 14, 9, "Aquaria");
...
let akeria = new Queen("A'keria C. Davenport", 11, 10, 11, 8, 13, 13, 10, "Akeria");
let ariel = new Queen("Ariel Versace", 8, 6, 6, 7, 5, 8, 6, "Ariel");
let brooke = new Queen("Brooke Lynn Hytes", 8, 8, 13, 12, 8, 14, 13, "Brooke");
let honeyd = new Queen("Honey Davenport", 4, 6, 8, 4, 4, 9, 4, "HoneyD");
let kahanna = new Queen("Kahanna Montrese", 4, 5, 12, 9, 5, 13, 11, "Kahanna");
let mercedes = new Queen("Mercedes Iman Diamond", 4, 6, 8, 8, 6, 10, 8, "Mercedes");
...
let scarlet = new Queen("Scarlet Envy", 13, 10, 7, 13, 9, 10, 7, "Scarlet");
...
//SEASON 12: acting, comedy, dance, design, improv, runway, lipsync
...
let gigi = new Queen("Gigi Goode", 9, 9, 11, 10, 9, 12, 8, "Gigi");
let heidi = new Queen("Heidi N Closet", 10, 9, 11, 8, 12, 9, 13, "Heidi");
let jackie = new Queen("Jackie Cox", 11, 12, 6, 6, 13, 9, 8, "Jackie");
let jaida = new Queen("Jaida Essence Hall", 8, 5, 10, 15, 7, 13, 12, "Jaida");
let jan = new Queen("Jan", 8, 4, 7, 9, 5, 10, 9, "Jan");
...
let denali = new Queen("Denali", 4, 8, 14, 9, 10, 8, 13, "Denali");
...
let kandym = new Queen("Kandy Muse", 9, 10, 9, 6, 10, 7, 11, "KandyM");
let lala = new Queen("LaLa Ri", 8, 10, 15, 6, 10, 8, 15, "Lala");
let olivia = new Queen("Olivia Lux", 11, 5, 11, 10, 8, 11, 8, "Olivia");
let rose = new Queen("Rosé", 12, 11, 6, 8, 10, 10, 6, "Rose");
...
let angeria = new Queen("Angeria Paris VanMicheals", 11, 10, 9, 12, 8, 11, 8, "Angeria");
let bosco = new Queen("Bosco", 11, 7, 6, 7, 8, 11, 9, "Bosco");
let daya = new Queen("Daya Betty", 9, 8, 9, 9, 9, 10, 7, "DayaBetty");
let deja = new Queen("DeJa Skye", 9, 8, 11, 8, 13, 8, 9, "DeJa");
let jasmineK = new Queen("Jasmine Kennedie", 8, 7, 13, 7, 6, 10, 14, "JasmineK");
let jorgeous = new Queen("Jorgeous", 5, 5, 15, 10, 5, 10, 15, "Jorgeous");
let june = new Queen("June Jambalaya", 5, 6, 6, 4, 5, 6, 6, "June");
let kerri = new Queen("Kerri Colby", 6, 6, 5, 5, 6, 9, 6, "Kerri");
let kornbread = new Queen("Kornbread Jeté", 9, 12, 8, 5, 10, 8, 10, "Kornbread");
let cadmen = new Queen("Lady Camden", 12, 11, 12, 11, 7, 10, 11, "LadyCamden");
let maddy = new Queen("Maddy Morphosis", 9, 12, 6, 8, 10, 9, 7, "Maddy");
let orion = new Queen("Orion Story", 4, 6, 6, 9, 6, 6, 5, "Orion");
let willow = new Queen("Willow Pill", 11, 11, 7, 12, 8, 13, 8, "Willow");
let us_season14 = [alyssaH, angeria, bosco, daya, deja, jasmineK, jorgeous, june, kerri, kornbread, cadmen, maddy, orion, willow];
//SEASON 15               
let amethyst = new Queen("Amethyst", 4, 9, 8, 5, 10, 7, 9, "Amethyst");
let anetra = new Queen("Anetra", 8, 9, 12, 10, 8, 9, 14, "Anetra");
let auraMayari = new Queen("Aura Mayari", 5, 5, 6, 7, 6, 9, 7, "AuraMayari");
let irene = new Queen("Irene Dubois", 4, 5, 4, 4, 4, 8, 6, "IreneDubois");
let jax = new Queen("Jax", 5, 7, 15, 9, 6, 8, 15, "Jax");
let loosey = new Queen("Loosey LaDuca", 11, 13, 6, 8, 13, 8, 6, "LooseyLaDuca");
let luxx = new Queen("Luxx Noir London", 10, 11, 9, 15, 9, 14, 10, "LuxxNoirLondon");
let malaysia = new Queen("Malaysia Babydoll Foxx", 9, 8, 7, 8, 7, 9, 8, "MalaysiaBabydollFoxx");
let marcia = new Queen("Marcia Marcia Marcia", 9, 9, 8, 8, 9, 8, 9, "MarciaMarciaMarcia");
let mistress = new Queen("Mistress Isabelle Brooks", 8, 15, 8, 13, 12, 13, 9, "MistressIsabelleBrooks");
let robin = new Queen("Robin Fierce", 7, 7, 11, 10, 6, 10, 11, "RobinFierce");
let salina = new Queen("Salina EsTitties", 9, 8, 8, 8, 8, 6, 11, "SalinaEsTitties");
let sashaColby = new Queen("Sasha Colby", 9, 10, 15, 13, 9, 15, 15, "SashaColby");
...
let morphine = new Queen("Morphine Love Dion", 6, 8, 10, 8, 6, 10, 12, "Morphine");
...
let sapphira = new Queen("Sapphira Cristál", 11, 12, 9, 11, 11, 12, 9, "Sapphira");
...
let blu = new Queen("Blu Hydrangea", 5, 8, 6, 10, 10, 12, 7, "Blu");
let cheryl = new Queen("Cheryl Hole", 5, 9, 8, 5, 9, 7, 9, "Cheryl");
let crystaluk = new Queen("Crystal", 6, 5, 6, 9, 4, 8, 6, "Crystal");
let divina = new Queen("Divina De Campo", 11, 6, 9, 12, 9, 9, 9, "Divina");
let gothy = new Queen("Gothy Kendoll", 5, 4, 4, 8, 2, 9, 4, "Gothy");
...
// ALL STARS 9
let allstars_9 = [angeria, plastique, jorgeous, shannel, roxxxy, vanessa, mik, ninaw];
...
let vanity = new Queen("Vanity Milan", 8, 8, 15, 7, 8, 10, 15, "Vanity");
let victoriaS = new Queen("Victoria Scone", 11, 10, 8, 10, 8, 10, 9, "VictoriaS");
...
let black = new Queen("Black Peppa", 5, 4, 11, 4, 6, 13, 13, "BlackPeppa");
let cheddar = new Queen("Cheddar Gorgeous", 12, 9, 7, 10, 13, 14, 8, "Cheddar");
let copper = new Queen("Copper Topp", 5, 4, 9, 7, 6, 7, 8, "Copper");
let dakota = new Queen("Dakota Schiffer", 6, 9, 9, 10, 9, 11, 8, "Dakota");
...
let michael = new Queen("Michael Marouli", 6, 10, 9, 8, 10, 12, 10, "Michael");
let naomiuk = new Queen("Miss Naomi Carter", 6, 6, 8, 4, 6, 9, 9, "NaomiUK");
let tomara = new Queen("Tomara Thomas", 8, 8, 15, 7, 10, 9, 12, "Tomara");
let vicki = new Queen("Vicki Vivacious", 7, 6, 7, 10, 5, 11, 7, "Vicki");
...
let juice = new Queen("Juice Boxx", 6, 6, 6, 4, 6, 6, 10, "Juice");
let kiara = new Queen("Kiara", 10, 6, 8, 11, 6, 9, 11, "Kiara");
let kyne = new Queen("Kyne", 8, 6, 6, 7, 6, 6, 7, "Kyne");
let lemon = new Queen("Lemon", 10, 9, 12, 6, 11, 9, 12, "Lemon");
let priyanka = new Queen("Priyanka", 14, 12, 12, 5, 6, 10, 13, "Priyanka");
let rita = new Queen("Rita Baga", 11, 10, 8, 3, 10, 7, 7, "Rita");
let bobo = new Queen("Scarlett BoBo", 6, 8, 15, 12, 10, 10, 15, "Scarlett");
let tynomi = new Queen("Tynomi Banks", 5, 6, 15, 7, 5, 7, 13, "Tynomi");
let can_season1 = [anastarzia, boa, ilona, jimbo, juice, kiara, kyne, lemon, priyanka, rita, bobo, tynomi];
//CAN SEASON 2       acting, comedy, dance, design, improv, runway, lipsync
let adriana = new Queen("Adriana", 9, 7, 7, 6, 6, 10, 7, "Adriana");
let beth = new Queen("Beth", 5, 5, 6, 3, 6, 5, 4, "Beth");
let eve = new Queen("Eve 6000", 10, 5, 5, 6, 6, 8, 8, "Eve");
let giametric = new Queen("Gia Metric", 11, 10, 8, 7, 10, 9, 7, "Giametric");
let icesis = new Queen("Icesis Couture", 8, 11, 9, 15, 12, 15, 14, "Icesis");
let kendall = new Queen("Kendall Gender", 6, 7, 10, 6, 7, 10, 10, "Kendall");
let kimoraA = new Queen("Kimora Amour", 6, 5, 6, 7, 7, 10, 5, "KimoraA");
let oceane = new Queen("Océane Aqua-Black", 6, 9, 9, 7, 7, 7, 10, "Oceane");
let pythia = new Queen("Pythia", 8, 9, 6, 14, 9, 13, 7, "Pythia");
let stephanie = new Queen("Stephanie Prince", 7, 7, 12, 12, 5, 11, 10, "Stephanie");
...
let jadashada = new Queen("Jada Shada Hudson", 9, 11, 9, 7, 8, 8, 14, "JadaShada");
let kaos = new Queen("Kaos", 5, 7, 5, 5, 5, 9, 9, "Kaos");
let kimmy = new Queen("Kimmy Couture", 7, 9, 12, 9, 6, 11, 15, "Kimmy");
let boomboom = new Queen("Lady Boom Boom", 8, 12, 12, 14, 8, 12, 10, "BoomBoom");
let fiercalicious = new Queen("Miss Fiercalicious", 11, 13, 9, 8, 7, 11, 9, "Fiercalicious");
...
let venuscan = new Queen("Venus", 10, 10, 10, 9, 10, 12, 9, "VenusCan");
let can_season4 = [aimee, aurora, denim, kikicoe, kitten, luna, melinda, nearah, sisi, girlfriend, venuscan];
...
let janey = new Queen("Janey Jacké", 7, 6, 13, 12, 6, 13, 13, "Janey");
let madamem = new Queen("Madame Madness", 8, 6, 5, 6, 5, 8, 7, "MadameM");
let mama = new Queen("Ma'Ma Queen", 9, 6, 5, 6, 6, 10, 7, "Mama");
let megan = new Queen("Megan Schoonbrood", 7, 6, 6, 5, 6, 9, 12, "Megan");
let abby = new Queen("Miss Abby OMG", 5, 6, 11, 6, 5, 8, 14, "Abby");
...
let keta = new Queen("Keta Minaj", 9, 8, 11, 11, 8, 12, 10, "Keta");
...
//DRAG RACE DOWN UNDER SEASON 2  acting, comedy, dance, design, improv, runway, lipsync
...
let hannah = new Queen("Hannah Conda", 11, 12, 8, 8, 11, 11, 8, "Hannah");
...
let arantxa = new Queen("Arantxa Castilla La Mancha", 6, 10, 6, 6, 8, 9, 7, "Arantxa");
...
let sethlas = new Queen("Drag Sethlas", 8, 10, 12, 9, 9, 12, 11, "DragSethlas");
...
let samantha = new Queen("Samantha Ballentines", 8, 10, 6, 5, 8, 8, 7, "Samantha");
...
let chuchi = new Queen("Drag Chuchi", 6, 6, 9, 6, 6, 6, 10, "DragChuchi");
...
let dres_season3 = [bestiah, chanel, clover, chuchi, hornella, maria, kellyRoller, pakita, pink, pitita, vania, macarena, visa];
//DRAG RACE ESPAÑA S1
let dresas_1 = [pupi, sagittaria, sethlas, juriji, onyx, samantha, hornella, pakita, pink];
//DRAG RACE ITALIA S1
...
let grandedame = new Queen("La Grande Dame", 10, 12, 7, 12, 8, 13, 8, "GrandeDame");
let kahena = new Queen("La Kahena", 5, 6, 3, 3, 5, 4, 5, "Kahena");
...
let marinaSummers = new Queen("Marina Summers", 8, 9, 12, 11, 8, 12, 10, "MarinaSummers");
...
let admira = new Queen("Admira Thunderpussy", 11, 9, 9, 6, 7, 11, 7, "AdmiraThunderpussy");
let almighty = new Queen("Almighty Aphroditey", 5, 4, 4, 5, 5, 4, 5, "AlmightyAphroditey");
let antonina = new Queen("Antonina Nutshell", 2, 2, 3, 4, 2, 2, 4, "AntoninaNutshell");
let elecktra = new Queen("Elecktra", 6, 8, 7, 5, 9, 9, 10, "Elecktra");
let endigo = new Queen("Endigo", 7, 5, 6, 4, 6, 4, 7, "Endigo");
let fontana = new Queen("Fontana", 7, 7, 7, 5, 7, 8, 9, "Fontana");
let imaa = new Queen("Imaa Queen", 8, 7, 5, 8, 4, 10, 4, "ImaaQueen");
let santana = new Queen("Santana Sexmachine", 7, 9, 9, 9, 8, 9, 6, "SantanaSexmachine");
let vanityVain = new Queen("Vanity Vain", 6, 5, 9, 11, 6, 12, 10, "VanityVain");
...
let ashley = new Queen("Ashley Madison", 7, 10, 5, 8, 10, 9, 6, "AshleyMadison");
let bumpa = new Queen("Bumpa Love", 7, 7, 6, 8, 8, 7, 9, "BumpaLove");
let flor = new Queen("Flor", 7, 6, 9, 8, 8, 10, 9, "Flor");
let gabriella = new Queen("Gabriella Labucci", 7, 10, 9, 7, 10, 8, 10, "GabriellaLabucci");
...
let ritaMenu = new Queen("Rita Menu", 6, 6, 7, 6, 5, 7, 7, "RitaMenu");
...
let serenaM = new Queen("Serena Morena", 6, 6, 5, 6, 6, 8, 9, "SerenaMorena");
let vermelha = new Queen("Vermelha Noir", 4, 4, 4, 5, 4, 7, 3, "VermelhaNoir");
...
let kellyH = new Queen("Kelly Heelton", 10, 11, 8, 9, 10, 9, 9, "KellyHeelton");
let leleC = new Queen("LeLe Cocoon", 6, 6, 5, 8, 5, 9, 6, "LeleCocoon");
let loreley = new Queen("Loreley Rivers", 8, 5, 8, 10, 7, 10, 10, "LoreleyRivers");
...
let yvonne = new Queen("Yvonne Nightstand", 10, 11, 7, 6, 8, 10, 7, "YvonneNightstand");
...
let darby = new Queen("Darby Lynn Cartwright", 10, 13, 8, 8, 12, 7, 9, "Darby");
let alexispb = new Queen("Alexis P Bevels", 12, 14, 8, 7, 8, 15, 7, "AlexisPB");
let chan = new Queen("Aunty Chan", 11, 12, 9, 8, 12, 10, 9, "Chan");
...
let allQueens = [
    ...
    aja, alexism, eureka, farrah, jaymes, kimora, ninab, peppermint, sasha, shea, trinity, valentina,
    ...
    amethyst, anetra, auraMayari, irene, jax, loosey, luxx, malaysia, marcia, mistress,robin, salina, sashaColby, spice, sugar,
